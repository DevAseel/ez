...
const Settings = () => {
  ...
  return (
    <>
      <Head>
        <title>EZ - Profile Settings</title>
        ...
        >
          ...
          <Flex flexDirection="column" width="80%">
            ...
            <Textarea
              ...
              defaultValue={userSettings?.bio ? userSettings.bio : ""}
              borderColor="#2D3748"
              fontWeight="light"
              name="bio"
              required
            ...
            <Input
              ...
              defaultValue={
                userSettings?.workingHours ? userSettings.workingHours : ""
              }
              fontWeight="light"
              borderColor="#2D3748"
              width="max-width"
            ...
            <Select
              ...
              defaultValue={userSettings?.timeZone ? userSettings.timeZone : ""}
              borderColor="#2D3748"
              fontWeight="light"
              color="#718096"
              name="timeZone"
            ...
            <InputGroup size="sm">
              ...
              <Input
                ...
                defaultValue={
                  userSettings?.githubAccount ? userSettings.githubAccount : ""
                }
                fontWeight="light"
                borderColor="#2D3748"
                name="githubAccount"
